  ...
  upperBody: {
    ...
    exercises: {
      1: {
        ...
        equiptmentRequired: ['dumbells'],
        equiptmentOptions: ["dumbells", "barbell", "curl machine", "rope"],
        ...
        variations: {
          ...
          1.1: {
            ...
            primaryMuscleGroups: ["biceps"],
            secondaryMuscleGroups: ['back','wrist'],
            equiptmentRequired: ['cabel weights'],
            equiptmentOptions: [''],
      ...
      2: { 
        ...
        equiptmentRequired: ['dumbells'],
        equiptmentOptions: ['shoulder press machine'],
        reps: 13,
        sets: 3,
        infoUrl: "",
      ...
      3: { 
        ...
        equiptmentRequired: ['bench', 'barbell'],
        equiptmentOptions: ['bench press machine'],
        reps: 13,
        sets: 3,
        infoUrl: "",
        ...
        variations: {
          ...
          3.1: {
            ...
            primaryMuscleGroups: ['chest', 'front delts'],
            secondaryMuscleGroups: ['triceps'],
            equiptmentRequired: ['dumbbells', 'incline bench'],
            equiptmentOptions: [''],
            reps: 13,
            sets: 3,
            infoUrl: "",
          ...
          3.2: {
            ...
            secondaryMuscleGroups: ['traps'],
            equiptmentRequired: ['incline bench', 'barbell'],
            equiptmentOptions: [''],
            reps: 13,
            sets: 3,
            infoUrl: "",
      ...
      4: {
        ...
        equiptmentRequired: ['incline bench', 'dumbbells'],
        equiptmentOptions: ['chest fly machine'],
        reps: 13,
        sets: 3,
        infoUrl: "",
      ...
      5: {
        ...
        secondaryMuscleGroups: ['shoulders'],
        equiptmentRequired: ['bench'],
        equiptmentOptions: ['dip bar'],
        reps: 13,
        sets: 3,
        infoUrl: "",
      ...
      10: {
        ...
        variations: {
          ...
          10.2: {
            ...
            primaryMuscleGroups: [],
            secondaryMuscleGroups: [''],
            equiptmentRequired: ['dumbbels'],
            equiptmentOptions: ['bench'],
            reps: 13,
            sets: 3,
            infoUrl: "",
          ...
          10.3: {
            ...
            primaryMuscleGroups: [],
            secondaryMuscleGroups: [''],
            equiptmentRequired: ['incline bench', 'dumbbels'],
            equiptmentOptions: [''],
            reps: 13,
            sets: 3,
            infoUrl: "https://youtu.be/H75im9fAUMc?t=36",
